...
class User extends CActiveRecord {
	...
	public function rules() {
		return array (
            ...
            //验证安全密码
            array('u_safe_pwd','checkSafePwd','on'=>'EditInfo,Ticket'),
            array ('u_safe_pwd','required','message'=>'安全码不能为空','on'=>'EditInfo,Register,Ticket'),
            array ('u_safe_pwd', 'length','min'=>6, 'max'=>16,'message'=>'安全密码位数不正确','on'=>'EditInfo,Register,Ticket'),
