	...
	public function actionShow($id){
		...
		if($msg->save()){
			...
			$rlt['data']=array(
					...
					'content'=>$purifier->purify($msg['m_content']),
					'list'=>$this->renderPartial('/layouts/_message',array('userId'=>Yii::app()->user->id),true),
					'count'=>$msg->getUnReadCount ( Yii::app()->user->id ),
			);
		}else{
			$rlt['msg']='消息状态更新失败';
		}
